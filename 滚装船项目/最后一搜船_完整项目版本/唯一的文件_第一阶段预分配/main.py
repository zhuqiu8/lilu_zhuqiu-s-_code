...
# 调用函数
excel_path = r"D:\Github\RORO_Project\OROR-PROJECT\25_1_6测试下一艘船_原堆场\第二次模型的输入数据.xlsx"  # 替换为实际的 Excel 文件路径
...
# yard_names = [
#     "Yard C1.1", "Yard C1.2", "Yard C1.3", "Yard C1.4", "Yard C1.5", "Yard B8",
#     "R 2", "A 8", "R 1", "A 7", "B 3", "R 3"
# ]
...
if model.status == GRB.OPTIMAL:
    ...
    file_path = os.path.join(output_dir, 'result1.xlsx')  # 可以更改
