...
# Example usage
initial_file_path = r"D:\Github\RORO_Project\OROR-PROJECT\25_1_6测试下一艘船_原堆场\第二次模型的输入数据.xlsx"
yard_names = read_yard_names(initial_file_path, sheet_name='Yard_Areas', column_name='yard_names')
visualize_bins_from_csv(r"D:\Github\RORO_Project\OROR-PROJECT\25_1_6测试下一艘船_原堆场\唯一的文件_第二阶段布局\阶段二布局.csv", yard_names)
