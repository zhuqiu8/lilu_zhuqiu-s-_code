...
# Example usage
initial_file_path = r"C:\Users\zhuqiu\Desktop\25年2月份RORO船改数据\25年2月roro船\2月输入数据2月13日晚更新.xlsx"
yard_names = read_yard_names(initial_file_path, sheet_name='Yard_Areas', column_name='yard_names')
visualize_bins_from_csv(r"C:\Users\zhuqiu\Desktop\25年2月份RORO船改数据\25年2月roro船\唯一的文件_第二阶段布局\阶段二布局.csv", yard_names)
